...
public interface SubCategoryRepository extends JpaRepository<SubCategory, Long> {
    ...
    @Query("select new peaksoft.dto.responses.subCategory.SubCategoryResponse(s.id,s.name) from SubCategory s")
    List<SubCategoryResponse> findAllSubCategoryResponse();

    boolean existsByName(String name);

    @Query("select new peaksoft.dto.responses.subCategory.SubCategoryResponse(s.id,s.name) from SubCategory s where s.id=:id")
    ...
    @Query("select new peaksoft.dto.responses.subCategory.SubCategoryResponsesByCategory(c.name,s.id,s.name) from Category c join c.subCategories s")
